...
<section class="content">
    ...
    <div class="container-fluid">
        ...
        <form action="<?php echo site_url('kamar/updateKamar/' . $kamar['id_kamar']); ?>" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <div class="col-12">
                                <img src="<?php echo base_url() ?>public/admin/img/db_images/<?= $kamar['foto_option1']?>" id="image-preview-utama" class="product-image" alt="Product Image">
                            </div>
                            <div class="col-12 product-image-thumbs">
                                <div class="product-image-thumb active"><img src="<?php echo base_url() ?>public/admin/img/db_images/<?= $kamar['foto_option1']?>" id="image-preview" alt="Product Image"></div>
                                <div class="product-image-thumb">
                                    <?php if ($kamar['foto_option2'] == null) { ?>
                                        <img src="<?php echo base_url() ?>public/admin/img/noimages/defaultimages.png" id="image-preview-kamar" alt="Product Image">
                                    <?php } else { ?>
                                        <img src="<?php echo base_url() ?>public/admin/img/db_images/<?= $kamar['foto_option2']?>" id="image-preview-kamar" alt="Product Image">
                                    <?php } ?>
                                </div>
                                <div class="product-image-thumb">
                                    <?php if ($kamar['foto_option3'] == null) { ?>
                                        <img src="<?php echo base_url() ?>public/admin/img/noimages/defaultimages.png" id="image-preview-toilet" alt="Product Image">
                                    <?php } else { ?>
                                        <img src="<?php echo base_url() ?>public/admin/img/db_images/<?= $kamar['foto_option3']?>" id="image-preview-toilet" alt="Product Image">
                                    <?php } ?>
                                </div>
                                <div class="product-image-thumb">
                                    <?php if ($kamar['foto_option4'] == null) { ?>
                                        <img src="<?php echo base_url() ?>public/admin/img/noimages/defaultimages.png" id="image-preview-option1" alt="Product Image">
                                    <?php } else { ?>
                                        <img src="<?php echo base_url() ?>public/admin/img/db_images/<?= $kamar['foto_option4']?>" id="image-preview-option1" alt="Product Image">
                                    <?php } ?>
                                </div>
                                <div class="product-image-thumb">
                                    <?php if ($kamar['foto_option5'] == null) { ?>
                                        <img src="<?php echo base_url() ?>public/admin/img/noimages/defaultimages.png" id="image-preview-option2" alt="Product Image">
                                    <?php } else { ?>
                                        <img src="<?php echo base_url() ?>public/admin/img/db_images/<?= $kamar['foto_option5']?>" id="image-preview-option2" alt="Product Image">
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="my-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="" class="form-control" value="<?= $kamar['nama_kosan']  ?>" readonly>
                                    <input type="text" name="id" class="form-control" value="<?= $kamar['id_kosan'] ?>" hidden>
                                    <input type="text" name="namakosan" class="form-control" value="<?= $kamar['nama_kosan'] ?>" hidden>
                                </div>
                                <div class="form-group">
                                    <label for="inputName">Nama/Nomor Kamar</label>
                                    <input type="text" name="namakamar" value="<?= $kamar['nama_kamar']  ?>" class="form-control" placeholder="Pelangi,C05,dll" required oninvalid="this.setCustomValidity('Nama Kamar Masih Kosong')" oninput="this.setCustomValidity('')">
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="rupiahbulan" name="tarif_bulan" class="form-control" placeholder="Rp. 300.000" value="<?= $kamar['tarif_perbulan']  ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="inputName">Tarif Kosan / Tahun</label>
                                        <input type="text" id="rupiahtahun" name="tarif_tahun" class="form-control" placeholder="Rp. 5.000.000" value="<?= $kamar['tarif_pertahun']  ?>">
                                    </div>
                                </div>
                            </div>
                            <hr>
